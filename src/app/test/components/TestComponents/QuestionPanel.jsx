                ...
                {dummyQuestion.examples.map((ex, index) => (
                    <div className='flex mb-2 rounded bg-gray-100' key={index}>
                        ...
                        <p className='w-1/2 p-2'>
                            <span className='font-semibold font-serif text-gray-600 text-sm'>Input:</span> <br />
                            <code className='font-medium  text-black text-sm'>{ex.input}</code>
                        </p>

                        {/* Output */}
                        <p className='w-1/2 p-2'>
                            <span className='font-semibold font-serif text-gray-600 text-sm'>Output:</span><br />
                            <code className='font-medium  text-black text-sm'>{ex.output}</code>
                        </p>
                    </div>
                ))}
            </div>
            ...
            <div>
                ...
                <ul>
                    {dummyQuestion.constraints.map((item, index) => (
                        <li key={index} className="mb-1 text-sm flex items-center text-black  gap-2">
                            <span className='text-gray-400  '>{'>'}</span>
                            <code className='inline-block bg-gray-100 px-2   py-1'>{item}</code>
                        </li>
                    ))}
                </ul>
            </div>
